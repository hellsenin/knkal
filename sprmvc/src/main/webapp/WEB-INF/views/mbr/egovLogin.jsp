...
<input type=hidden name=login_error value="${login_error}" />
	...
	<!-- // 타이틀 -->
	<div id="table">
	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;" summary="아이디와 비밀번호를 입력하여 회원 로그인을 합니다.">
		<caption>로그인</caption>
		<thead>
		<colgroup>
			<col width="150" >
		...
		<tr>
			...
			<td class="tbtd_content">
					<input name="j_username" maxlength="10" title="id"/>	</td>
		</tr>
		<tr>
			<td class="tbtd_caption"><spring:message code="mbr.header.pass" /></td>
			<td class="tbtd_content">
				<input type=password name="j_password" maxlength="20" title="pass"/></td>
		</tr>
	</table>
  </div>
	<div id="sysbtn">
		<ul>
			<li><span class="btn_blue_l" title="<spring:message code="mbr.login" />"><a href="#link" onClick="fn_egov_login(); return false;"><spring:message code="mbr.login" /></a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" style="margin-left:6px;" alt="로그인"/></span></li>
