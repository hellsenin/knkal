...
public class StringUtil {
	 ...
	 * @throws IOException
	 */
	public static void htmlPrint(HttpServletResponse res, String content)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void toMessage(HttpServletResponse res, String message)
		throws IOException {
