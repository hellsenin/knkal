...
<%
/**
 * @JSP Name : transactionFailure.jsp
 * @Description : 트랜잭션 에러화면
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td width="399" align="left" class="board_title"><spring:message code="error.msg.transaction" /></td>
                  </tr>
                </table>
        	 </td>
              </tr>
