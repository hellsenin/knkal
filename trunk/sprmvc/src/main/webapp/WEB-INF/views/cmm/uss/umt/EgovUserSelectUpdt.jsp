                    ...
                    <div class="modify_user" >
                        <table>
                            <tr> 
				                ...
				                <td width="30%" ><label for="emplyrId"></label>
				                ...
				                <td width="30%" ><label for="moblphonNo"></label>
                            ...
                            <tr> 
				                ...
				                <td width="30%" ><label for="passwordHint"></label>
				                ...
				                <td width="30%" ><label for="passwordCnsr"></label>
                            ...
                            <tr> 
				                ...
				                <td width="30%" ><label for="emplyrNm"></label>
				                ...
				                <td width="30%" ><label for="insttCode"></label>
                            ...
                            <tr> 
				                ...
				                <td width="30%" ><label for="orgnztId"></label>
				                ...
				                <td width="30%" ><label for="ofcpsNm"></label>
                            ...
                            <tr>
				                ...
				                <td width="30%" ><label for="emailAdres"></label>
				                ...
				                <td width="30%" ><label for="areaNo"></label>
				                    <form:input path="areaNo" id="areaNo" cssClass="txaIpt" size="5" maxlength="5" />
				                    - <label for="homemiddleTelno"></label><form:input path="homemiddleTelno" id="homemiddleTelno" cssClass="txaIpt" size="5" maxlength="5" />
				                    - <label for="homeendTelno"></label><form:input path="homeendTelno" id="homeendTelno" cssClass="txaIpt" size="5" maxlength="5" />
                            ...
                            <tr> 
				                ...
				                <td width="30%" ><label for="offmTelno"></label>
				                ...
				                <td width="30%" ><label for="fxnum"></label>
                            ...
                            <tr>
				                ...
				                <td width="30%" ><label for="homeadres"></label>
				                    <form:input path="homeadres" id="homeadres" cssClass="txaIpt" size="40" maxlength="100" readonly="true"/>
				                    <form:errors path="homeadres" cssClass="error" />
				                    <input name="zip_view" id="zip_view" type="hidden" size="20" value="<c:out value='${userManageVO.zip}'/>"  maxlength="8" readonly/>
				                ...
				                <td width="30%" ><label for="detailAdres"></label>
                            ...
                            <tr> 
				                ...
				                <td width="30%" ><label for="emplyrSttusCode"></label>
				                ...
				                <td width="30%" ><label for="groupId"></label>
