...
<html lang="en">
    <head>
    	...
    	<link href="/pola/css/examples.css" rel="stylesheet" />
    	<link href="/pola/css/menu.css" rel="stylesheet" />

    	<script src="/pola/js/ext-core-debug.js"></script>
        <script src="/pola/js/menu.js"></script>
